...
public class WalletManager : MonoBehaviour {
    ...
    public void Awake() { if (instance == null) Debug.Log("Get data"); instance = this; }
    ...
    void LoadWalletsFromFile()
    {
        ...
        if (exist)
        {
            ...
            file = GetStreamFromUrl(filePath);
    ...
    public void RefreshTopPanelView()
    {
        ...
        int index = 1;//walletSelectionDropdown.value;
